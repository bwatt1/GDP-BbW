/************************ dSPACE target specific file *************************
   ...
   Include file .\test00_mdl_rti1401\test00_mdl_th.c :

   Task Configuration file for model : test00_mdl

   RTI1401 24.1 (02-May-2024)/2.20
   23-Apr-2025 19:06:31
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\test00_mdl_rti1401\test00_mdl_th.c is for ST).
# endif
