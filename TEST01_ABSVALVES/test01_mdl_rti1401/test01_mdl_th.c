/************************ dSPACE target specific file *************************
   ...
   Include file .\test01_mdl_rti1401\test01_mdl_th.c :

   Task Configuration file for model : test01_mdl

   RTI1401 24.1 (02-May-2024)/2.20
   25-Apr-2025 15:48:46
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\test01_mdl_rti1401\test01_mdl_th.c is for ST).
# endif
