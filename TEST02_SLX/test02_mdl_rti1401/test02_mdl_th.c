/************************ dSPACE target specific file *************************
   ...
   Include file .\test02_mdl_rti1401\test02_mdl_th.c :

   Task Configuration file for model : test02_mdl

   RTI1401 24.1 (02-May-2024)/2.20
   25-Apr-2025 16:39:12

   MATLAB 24.1.0.2837808 (R2024a) Update 7
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\test02_mdl_rti1401\test02_mdl_th.c is for ST).
# endif
